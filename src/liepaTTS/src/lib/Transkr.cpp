...
//nauja ---
//originalas: (int) pacastinimas pakeistas i (long), nes: on 64 bit sizeof(char*) is 8 and sizeof(int) is 4, on 32 bit sizeof(char*) is 4 and sizeof(int) is 4
...
*/
 if(( (Taisykl[j].KKont[0]!=0 ) ? (long)strchr(Taisykl[j].KKont, eil[i-1]):1)
   &&((Taisykl[j].DKont1[0]!=0) ? (long)strchr(Taisykl[j].DKont1, eil[i+k]):1)
   &&((Taisykl[j].DKont2[0]!=0) ? (long)strchr(Taisykl[j].DKont2, eil[i+k+1]):1)
