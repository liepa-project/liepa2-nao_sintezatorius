...
// Veiksmai su failais (nuskaito duomenis ir áraðo rezultatus).
...
int nuskaityti_signala()
{
...
#ifdef MEMORY_MAPPED
	// gauname WinAPI suprantamà failo identifikatoriø
	...
	// suformuojame mapping'o vardà
	// tai turëtø leisti naudoti tà paèià atmitá keliuose procesuose
	...
	// sukuriame mapping'à ir gauname rodyklæ á failo duomenis
...
//		eilute = strtok (NULL, skirtukai); // fonemos svoris						//20180125
	   ...
	   // nuskaitome iki eilutes pabaigos, nes daugiau mums nieko nereikia, todël nieko nedarome
		eilute = strtok(NULL, "\n"); // eilute iki pabaigos
