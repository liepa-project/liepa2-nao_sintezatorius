...
// [nuo 7 versijos 5 scenarijus nebeveikia, nes funkcija nuskaityti_anotacijas() pakeista dël to, kad pasikeitë anotacijø failo formatas]
...
// garso signalo masyvas, iðskiriamas dinamiðkai arba atitika memory-mapped failà
short * signalas = NULL;
